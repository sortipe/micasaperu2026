      ...
      <div className="bg-white rounded-3xl border border-gray-200 p-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/3 flex flex-col justify-center">
          <h2 className="text-3xl font-black text-slate-900 mb-4 leading-tight">
            Â¿Conoces nuestras opciones<br />de desarrollos?
          </h2>
          <p className="text-slate-600 text-sm mb-8">
            Puedes verlos segÃºn la etapa de construcciÃ³n que mÃ¡s se ajusta a tu bÃºsqueda.
          </p>
            ...
            {filteredProperties.map(property => (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-grow">
                  <p className="text-[10px] text-gray-500 mb-1">Proyecto Â· {property.type}</p>
                  ...
                  <div className="mt-auto flex items-center gap-4 text-[10px] text-gray-600">
                    <div className="flex items-center gap-1">
                      ...
                      {activeTab === 'EN_PLANOS' ? 'En planos' : activeTab === 'ENTREGA_INMEDIATA' ? 'Entrega inmediata' : 'En construcciÃ³n'}
                    </div>
                    <div className="flex items-center gap-1">
