        ...
        return (
          <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 animate-fade-in space-y-12">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {paymentMethods.map(method => (
                  <div key={method.id} className="p-8 bg-gray-50 rounded-[2.5rem] border border-gray-100 space-y-6 relative group">
                     ...
                     <div className="flex flex-wrap gap-2">
                        {(['TRANSFER', 'QR', 'MERCADOPAGO'] as const).map(t => (
                          <button 
                            key={t}
                          ...
                          >
                            {t === 'TRANSFER' ? 'Transferencia' : t === 'QR' ? 'QR / Billetera' : 'Mercado Pago'}
                          </button>
                        ))}
                      </div>
             ...
             <div className="pt-10 mt-10 border-t border-gray-100">
               <div className="flex items-center justify-between mb-8">
                  <h3 className="text-xl font-black text-[#091F4F] uppercase tracking-tight">Credenciales de Mercado Pago</h3>
               </div>
               <div className="max-w-xl">
                  <div className="p-8 bg-gray-50 rounded-3xl space-y-4">
                     <p className="text-[10px] text-gray-500 font-bold uppercase pb-2 leading-relaxed">Configura estas credenciales para generar pasarelas de pago usando Checkout Pro.</p>
                     <div className="space-y-2">
