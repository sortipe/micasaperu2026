  ...
  useEffect(() => {
    ...
    if (!focusedLocation) {
      ...
      if (properties.length > 0) {
        ...
        // Si no hay ubicaciÃ³n enfocada ni propiedades, reseteamos a la vista base (Lima)
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-[3000] w-full max-w-sm px-4">
          <div className="bg-white rounded-[2rem] shadow-2xl border border-gray-100 flex p-3 animate-slide-up">
            <div className="w-24 h-24 rounded-xl overflow-hidden shrink-0">
              <img loading="lazy" src={focusedProperty.featuredImage} className="w-full h-full object-cover" alt="Thumb" />
            </div>
