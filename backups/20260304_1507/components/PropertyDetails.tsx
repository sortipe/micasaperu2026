...
const ContactFormModal = ({ property, agentName, onClose, onSend, showToast }: { property: Property, agentName: string, onClose: () => void, onSend: (data: Partial<Inquiry>) => Promise<void>, showToast: (message: string, type: ToastType) => void }) => {
      ...
      <div className="bg-white w-full max-w-sm rounded-[2.5rem] shadow-2xl overflow-hidden animate-slide-up relative">
        ...
        <div className="p-6 md:p-8">
          <div className="text-center mb-6">
            <div className="w-12 h-12 bg-red-50 text-red-500 rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-inner">
