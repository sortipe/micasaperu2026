...
interface NavbarProps {
  user: User | null;
  onNavigate: (view: 'HOME' | 'ADMIN' | 'DETAILS' | 'SEARCH' | 'DASHBOARD' | 'PRICING' | 'AUTH' | 'COMPLAINTS_BOOK') => void;
  currentView: string;
  logo?: string | null;
}

const Navbar: React.FC<NavbarProps> = ({ user, onNavigate, currentView, logo }) => {
